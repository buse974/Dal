...
class AbstractModelTest extends PHPUnit_Framework_TestCase
{
	...
	{
		$mock_model = $this->getMockForAbstractClass('\Dal\Model\AbstractModel', array(), '', false, true, true, array('setToto','setTata'));
	...
	public function testToArray()
	{
		...
		$mock_model = $this->getMockForAbstractClass('\Dal\Model\AbstractModel', array(null, 'prefix'), '', true, true, true, array('getToto','getTata','getNothing','getNull','getChild','getOtherObj'));
